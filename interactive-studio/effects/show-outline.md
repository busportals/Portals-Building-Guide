...
* Helping signal to users which object they need
...
| ------------- | ---------------- | --------------------------------------------------- |
| Width         | Slider           | Sets the px width of the outline shown              |
| Outline Color | Color Selector   | Select the color of the outline you wish to display |
