...
* Turning off the outline you previously showed a user

{% hint style="info" %}
**Note:** The color of the outline you wish to hide should match the color of the outline shown.
{% endhint %}
...
| ------------- | ---------------- | ------------------------------------------------------ |
| Outline Color | color selector   | Use the color selector to choose which outline to hide |
