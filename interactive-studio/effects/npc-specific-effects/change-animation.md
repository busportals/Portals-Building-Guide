...
* Give NPCs funny reactions when players do something.
...
| -------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| Enter Animation Name | <p>Sitting<br>Can Can<br>Wave<br>Salute<br>Jive<br>Salsa<br>Shuffling<br>Chicken<br>Slide n Jive<br>Robot</p> | Choose an emote for your NPC to use from the 10 available. |
