...
| ---------------- | ---------------- | ----------------------------------------------------------------------------------------------------------------- |
| Iframe URL       | String           | This will be a URL to a website.                                                                                  |
| NPC will animate | Toggle           | When this is toggled on with a properly configured dialogue iframe on an NPC object the NPC's mouth will animate. |
