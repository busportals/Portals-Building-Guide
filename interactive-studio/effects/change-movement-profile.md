...
* Changing player speed when they get "stuck in honey" or hit a "speed boost"
...
| ---------------------- | ---------------- | -------------------------------------------------- |
| Movement Profile Label | String           | Enter the name of a movement profile to switch to. |
