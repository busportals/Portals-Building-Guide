...
* Give players flight for wearing an outfit.
* Creating bumper pads.
...
| ------- | ------------------------------------- | ------------------------------- |
| X       | Positive & negative numerical values. | Applies velocity on the X axis. |
| Y       | Positive & negative numerical values. | Applies velocity on the Y axis. |
| Z       | Positive & negative numerical values. | Applies velocity on the Z axis. |
