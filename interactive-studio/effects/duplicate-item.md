...
* Duplicate moving objects (this is how perilous pipes functions).
...
| ----------------------- | ---------------------- | -------------------------------------------------------------- |
| Set Destination         | Set using build tools. | Set the destination you would like the item to duplicate to.   |
| Destroy after X Seconds | Integer                | Set the time length in seconds before the object is destroyed. |
