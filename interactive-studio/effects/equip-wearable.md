...
* Give your users items (weapons, armor, clothes, etc.)
* Give your users special abilities
...
| ------- | --------------------------- | ------------------------------------------------------------------- |
| Item ID | String value of the Item ID | As of now the item ID will need to be provided by the Portals team. |
