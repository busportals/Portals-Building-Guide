...
* lock the camera distance for the player
* dynamically enter first person mode
...
| ----------- | ---------------- | ------------------------------------------------------------------------------ |
| Zoom Amount | slider           | Zoom amount of 0 is first person. Higher amounts make the camera further away. |
| Lock Zoom   | toggle           | Prevents the users from changing the zoom distance                             |
