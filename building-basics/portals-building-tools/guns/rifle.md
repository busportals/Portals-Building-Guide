...
The Rifle is a weapon that fires projectiles. It uses hitscan mechanics for instant hit detection.

### Damage Settings

#### Damage Falloff

The rifle's damage varies based on distance from the target:
